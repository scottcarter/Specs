...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/scottcarter/FastStart_DTBonjour"
  spec.author       = { "Oliver Drobnik" => "oliver@drobnik.com" }
  spec.source       = { :git => "https://github.com/scottcarter/FastStart_DTBonjour.git", :tag => spec.version.to_s }
